...
public class UpdateResponseWithAR extends UpdateResponse {
    ...
    //public UpdateResponseWithAR(UpdateResponse ret, BindingsResults added, BindingsResults removed) //BK
    public UpdateResponseWithAR(String ret, BindingsResults added, BindingsResults removed) {
        super(ret);
